          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 border border-gray-100">
              ...
              <p className="text-[#42526B] leading-relaxed">
                ...
                understanding of digital marketing strategies. From social media
                management to content creation, each module is crafted to
                empower you with the skills needed to create effective and
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100">
              ...
              <p className="text-[#42526B] leading-relaxed">
                Move beyond theory and step into real-world scenarios of digital
                marketing. Through our digital marketing agency, Mediacrest
                Digital, you will engage in real-world practical projects,
                collaborative ventures and digital marketing campaigns that
                mirror the challenges and opportunities of the professional
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100">
              ...
              <p className="text-[#42526B] leading-relaxed">
                Gain hands-on experience with industry-standard tools and
                platforms used in digital marketing. Our course ensures you are
                well-equipped with the technical proficiency demanded by the
                ever-evolving digital marketing industry.
              </p>
            </div>
          </div>
        </div>
