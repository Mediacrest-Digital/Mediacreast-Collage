...
export default function Index() {
  ...
  const courseFromUrl = searchParams.get("course") || "Graphic Design";
      ...
      if (response.ok) {
        ...
        try {
          const emailResponse = await fetch("/api/application", {
            ...
            body: JSON.stringify({ ...formData, course: "graphic-design" }),
          });
  ...
  return (
    <div className="min-h-screen bg-white font-poppins relative">
      ...
      <section className="relative">
        <div className="absolute inset-0 bg-black h-[400px] md:h-[536px] top-0 z-0"></div>
        <img
          ...
          className="absolute right-0 top-0 w-full md:w-[1007px] h-[400px] md:h-[536px] object-cover z-0"
        />
              ...
              <div className="flex flex-col md:flex-row gap-[16px] md:gap-[18px]">
                <div className="flex-1 space-y-[5px]">
                  ...
                  <input
                    ...
                    className="w-full h-[53px] px-[14px] py-[15px] border border-[rgba(145,158,171,0.32)] rounded-[8px] text-[14px] leading-[24px] placeholder:text-[rgba(17,15,36,0.40)]"
                  />
                </div>
                <div className="flex-1 space-y-[5px]">
                  <label className="text-[#5E5E5E] text-[14px] font-medium leading-[26px]">
