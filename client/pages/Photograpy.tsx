    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 md:px-16">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          >
            <p className="text-[#7B7B7B] leading-8 mb-4">
This foundation certificate program provides a comprehensive education in photography and videography. You'll learn everything from the basics of camera operation to advanced lighting and editing techniques, preparing you for a successful career in multimedia. The curriculum is structured to progressively build your skills, starting with core principles and advancing to complex photography and videography projects. Using our state-of-the-art cameras, you will learn to light, shoot and edit.
            </p>
