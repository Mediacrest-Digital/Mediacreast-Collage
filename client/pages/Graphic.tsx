...
import Try from "./Try";
import FAQAccordion from "../Component/courseDropdown2";
import Footer from "../Component/Footer";
import graphicpic from "../images/graphic3.png"
const AccordionItem = ({
  question,
  isOpen,
  onToggle,
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <p className="text-white text-lg leading-7 max-w-lg">
                  This graphic design course is focused on equipping essential skills
                  in digital design, using design tools such as Adobe Illustrator,
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-[#7A746D] leading-relaxed">
                   The Graphic Design Certification at Mediacrest Training College
                    is a comprehensive program designed to equip students with the 
                    essential skills and knowledge needed for a successful career in
                     graphic design. This course covers fundamental design principles,
                      industry-standard software, and practical application of design skills.
                       Students will develop a strong understanding of both the creative and technical aspects of graphic design,
                       preparing them for the multifaceted demands of the industry. Through a blend of theoretical knowledge and hands-on projects, 
                       you’ll build a versatile skill set that prepares you for various roles in graphic design. The program emphasizes practical experience, 
                       ensuring that graduates are ready to meet the challenges of real-world design environments.
                </p>
                <div className="pl-4 border-l-4 border-[#EB4823]">
                  <p className="text-[#7A746D] leading-relaxed">
                    You'll learn to conceptualize, create, and execute 
                    design projects using industry-standard tools and
                     techniques. This course equips you with the skills,
                      creativity, and industry connections needed to thrive 
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 border border-gray-100">
              ...
              <p className="text-[#42526B] leading-relaxed">
                Immerse yourself in a curriculum designed to nurture your
                creativity and refine your design skills. From color theory
                to layout composition, each module is crafted to empower you with
                the skills needed to bring your artistic vision to life.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100">
              ...
              <p className="text-[#42526B] leading-relaxed">
                Gain hands-on experience with industry-leading design software
                 used by professionals. Our course ensures you are well-equipped 
                 with the technical proficiency demanded by the ever-evolving 
             ...
             Real-World Design Experience   
              ...
              <p className="text-[#42526B] leading-relaxed">
                Move beyond theory and step into real-world scenarios of
                 graphic design. Engage in practical projects, collaborative ventures,
                  and design challenges that mirror the challenges and opportunities of the
                   professional graphic design landscape.
              </p>
            </div>
          </div>
        </div>
...
<Link to="/application" className="text-[#EB4823] underline ml-1">
 ...
 <div className=" borderD hidden md:block h-px  flex-1"></div>              </div>
    ...
    <FAQAccordion/>
      ...
      <section className="py-16 px-4 md:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="relative bg-gradient-to-r from-[#EB4823] to-[#ff6542] rounded-3xl overflow-hidden">
            <img
